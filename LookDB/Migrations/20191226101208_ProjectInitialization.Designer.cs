...
namespace LookDB.Migrations
{
    ...
    [Migration("20191226101208_ProjectInitialization")]
            ...
            modelBuilder.Entity("LookDB.Model.Member.DtMember", b =>
                {
                    ...
                    b.Property<DateTime>("InsertDate")
                        ...
                        .HasDefaultValue(new DateTime(2019, 12, 26, 17, 12, 7, 915, DateTimeKind.Local).AddTicks(8651));
                    ...
                    b.HasIndex("ActiveBool");

                    b.HasIndex("Address");

                    b.HasIndex("AddressCity");

                    b.HasIndex("AddressProv");

                    b.HasIndex("BackName");

                    b.HasIndex("DateBirth");

                    b.HasIndex("Email");

                    b.HasIndex("FrontName");
